package com.myclub.generadorqr
...
import com.myclub.generadorqr.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(){
    ...
    fun guardarQR() {
        ...
        val fecha = Date()
        try {
            val mPath = Environment.getExternalStorageDirectory().toString() + "/" + fecha + ".png"
